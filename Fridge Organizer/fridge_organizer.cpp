//written by Tristan Curry 20711720 and Diyane Fernando 20743873
#include <string>
#include <iostream>
#include <list> 
#include <stack> 
...
FridgeOrganizer::MealPortion FridgeOrganizer::remove_meal_portion() {
	...
	stack<MealPortion*>* newStack = stacks.back();
